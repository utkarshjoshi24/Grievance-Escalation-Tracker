...
export const AuthorityNotificationsPage = () => {
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/[0.06]">
        <div>
          <h1 className="text-2xl font-bold text-on-surface tracking-tight">
            Authority Alerts & SLA Warnings
          </h1>
          <p className="text-xs text-outline font-mono mt-0.5">
            Real-time escalation dispatches and impending breach warnings
          </p>
        </div>
      ...
      {userNotifications.length === 0 ? (
        <EmptyState
          ...
          title="No Authority Notifications"
          description="Your queue is currently clear of critical SLA alerts."
        />
      ) : (
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="pt-2 flex items-center gap-3">
                      {notif.grievanceToken && (
                        <Link
                          to={`/authority/grievances/${notif.grievanceToken}`}
                          className="text-xs font-mono text-primary hover:underline flex items-center gap-1"
                        >
                          <span>Review Grievance {notif.grievanceToken}</span>
